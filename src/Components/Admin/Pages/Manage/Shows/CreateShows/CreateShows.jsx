...
import { useCreateShowMutation } from '../../../../../../queries/useShows'
...
const CreateShows = () => {
  ...
  } = useForm({ resolver: zodResolver(showSchema) })

  const onSubmit = async (show) => {
    try {
      await createShowMutation.mutateAsync(show)
